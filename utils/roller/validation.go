...
func IsValidDAType(t string) bool {
	...
	case consts.Local, consts.Celestia, consts.Avail, consts.LoadNetwork, consts.Bnb, consts.Aptos, consts.Sui, consts.Walrus, consts.Kaspa, consts.Ethereum, consts.Solana:
		return true
	}
	return false
}
